            ...
            <tr>
              ...
              <td class="text-center">
                <a href="<?= BASE_URL . "index.php?page=my_profile&module=user&action=form&user_id=$data[user_id]" ?>"
                  class="btn btn-sm btn-warning col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4 mr-3 mt-1 mb-1"><i
                    class="fas fa-edit"></i></a>
                <a href="<?= BASE_URL . "module/user/action.php?button=Delete&user_id=$data[user_id]" ?>"
                  class="btn btn-sm btn-danger col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4"><i
